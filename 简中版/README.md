...
本书的研究对象横跨：个人，团队，组织，政府，文明。  
当研究对象遇到“想要得到”和“实际得到”发生偏差时，当一个人的决策出于“善良”却得到“非所愿的结果”时（好心办坏事）。
本书尝试回答研究对象的如下问题：  
1、为什么会发生“好心办坏事”？  
2、造成这种“悲剧”的原因是什么？  
3、我为什么会这么想，这么说，这么做；而现实为什么会给我这种回馈？
---
...
3、根据手册`AiInstructManual_CHN.pdf` 的提示进行测试或交互——或者你可以干脆想怎么问就怎么问。

>* Note:  
在非专业用法时：  
——你完全无需去关心整个理论的框架是如何搭建的。  
——如果Ai输出用了术语，记得提醒它——使用科普的语气输出。  

* ### 专业级用法：  

如果要进行专业级使用，建议步骤如下：  
1、先试着使用非专业用法练练手，熟悉Ai指令的输入和输出。  
2、认真研读一遍本书，彻底熟悉《衡论》的整个分析框架（一直学习到可以将元价值（生存）都替换掉的框架操作能力。）  
3、设计针对自己专业内的测试问题集（书中有范例——演示了对经济学的测试框架），进行专业可靠性压力测试测试。  
4、开始正常使用  
...
## 🌐 开源说明  
本书以“故意粗糙”的风格撰写，遣词造句上使用“市井风格”，旨在防止其被教条化或神圣化，并尽力惠及非哲学学术背景的读者。  
作者鼓励读者：  
...
## 🙏 致谢  
感谢 DeepSeek 团队提供的大语言模型支持，没有其高效的对话与验证能力，本书几乎无法完成。  
